...
type CountryResult = {
  ...
  investmentRecommendation: { action: "advance" | "test" | "discard" | "insufficient_data"; label: Localized; summary: Localized; selectedMode: Localized | null; selectedModeKey: ModeKey | null; reasons: Localized[] };
